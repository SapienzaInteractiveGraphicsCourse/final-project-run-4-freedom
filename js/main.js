...
window.onload = function main() {
    ...
    function setupGraphics() {
        ...
        const renderer = new THREE.WebGLRenderer({ canvas: canvas, antialias: aa, powerPreference: "high-performance", precision:"lowp" });
        ...
        const staticModels = {
            ...
            //17.7k  brick apartment 
            apartment1: {
                url: 'src/environment/city/buildings/apartment_1/scene.gltf',
                position: [70, 15, -150],
                scale: [0.05, 0.05, 0.05],
                rotation: [0, 0, 0],
            },
            ...
            //6.7k
            bordeauxBuilding: {
                url: 'src/environment/city/buildings/bordeaux_building/scene.gltf',
                position: [-50, 0, -190],
                scale: [13, 13, 13],
                rotation: [0, 0, 0],
            },

            //8.1k old city building
            building4: {
                url: 'src/environment/city/buildings/building_4/scene.gltf',
                position: [50, 10, 250],
                scale: [12, 12, 12],
                rotation: [0, Math.PI / 2, 0],
            },
            ...
            //37k
            kontra: {
                url: 'src/environment/city/buildings/building_kontra/scene.gltf',
                position: [-40, 0.5, -260],
                scale: [5, 5, 5],
                rotation: [0, Math.PI / 2, 0],
            },
            ...
            //19k
            motel: {
                url: 'src/environment/city/buildings/motel/scene.gltf',
                position: [-50, 0.3, -530],
                scale: [1.8, 1.8, 1.8],
                rotation: [0, 0, 0],
            },
            ...
            //16k
            gasStation: {
                url: 'src/environment/city/buildings/gas_station/scene.gltf',
                position: [-40, 0, -330],
            ...
            //37k
            office: {
                url: 'src/environment/city/buildings/office_1/scene.gltf',
                position: [250, 1, -800],
            ...
            //95k
            setOfBuildings: {
                url: 'src/environment/city/buildings/set_of_buildings/scene.gltf',
                position: [300, 118, 240],
                scale: [0.01, 0.01, 0.01],
                rotation: [0, 0, 0],
            },

            //7.5K LACKSTONE APARTMENTS
            apartment3: {
                url: 'src/environment/city/buildings/apartment_3/scene.gltf',
                position: [-70, 1, -140],
            ...
            //6K  
            tower: {
                url: 'src/environment/city/buildings/park_tower_chicago/scene.gltf',
                position: [-90, 1, 300],
                scale: [0.01, 0.01, 0.01],
                rotation: [0, Math.PI / 2, 0],
            },
            ...
            //7.7k miami style condominium
            apartment6: {
                url: 'src/environment/city/buildings/apartment_6/scene.gltf',
                position: [-200, 1, 150],
                scale: [0.025, 0.025, 0.025],
                rotation: [0, Math.PI / 2, 0],
            },
            ...
            //5.2k house 01
            house2: {
                url: 'src/environment/city/buildings/house_2/scene.gltf',
                position: [-30, -1, -60],
                scale: [0.03, 0.03, 0.03],
                rotation: [0, 0, 0],
            },

            //4.5k house white bricks
            house3: {
                url: 'src/environment/city/buildings/house_3/scene.gltf',
                position: [-60, -1, -150],
            ...
            //4.6k
            easternEuHouse: {
                url: 'src/environment/city/buildings/eastern_european_panel_house/scene.gltf',
                position: [40, 0, 90],
                scale: [0.1, 0.1, 0.1],
                rotation: [0, -Math.PI / 2, 0],
            },
            ...
            //5.6k new york apartment building
            apartment4: {
                url: 'src/environment/city/buildings/apartment_4/scene.gltf',
            ...
            building2: {
                url: 'src/environment/city/buildings/building_2/scene.gltf',
                position: [0, 0, -40],
                scale: [0.3, 0.3, 0.3],
                rotation: [0, Math.PI / 2, 0],
            },
            ...
            //3.5k building game ready
            building3: {
                url: 'src/environment/city/buildings/building_3/scene.gltf',
                position: [50, 0, -50],
                scale: [0.03, 0.03, 0.03],
                rotation: [0, -Math.PI / 2, 0],
            },
            ...
            //2.6k low rise office building
            building5: {
                url: 'src/environment/city/buildings/building_5/scene.gltf',
                position: [100, 0, -150],
                scale: [0.03, 0.03, 0.03],
                rotation: [0, -Math.PI / 2, 0],
            },
            ...
            //1.7k low rise office building
            building6: {
                url: 'src/environment/city/buildings/building_6/scene.gltf',
                position: [80, 0, -620],
                scale: [0.01, 0.01, 0.01],
                rotation: [0, -Math.PI / 2, 0],
            },
            ...
            house1: {
                url: 'src/environment/city/buildings/house_1/scene.gltf',
                position: [60, -1, -60],
                scale: [0.01, 0.01, 0.01],
                rotation: [0, -Math.PI/2 , 0],
            },
        ...
        const dynamicModels = {
            ...
            /*
            policeCar: {
                url: 'src/vehicles/cars/police_car/scene.gltf',
                position: [-1.5, 0, 25],
                scale: [2.2, 2.2, 2.2],
                rotation: [0, Math.PI, 0]
            },
          ...
          bmwI8:              { url: 'src/vehicles/cars/bmw_i8/scene.gltf',
            ...
            americanMuscleCar: {
                url: 'src/vehicles/cars/american_muscle_car/scene.gltf',
                position: [20, 2, 0],
                scale: [6, 6, 6],
                rotation: [0, Math.PI / 2, 0]
            },
            ...
            camper1: {
                url: 'src/vehicles/cars/camper_volkswagen/scene.gltf',
                position: [16, 0, -40],
                scale: [3.5, 3.5, 3.5],
                rotation: [0, -Math.PI / 2, 0]
            },
            ...
            mercedes: {
                url: 'src/vehicles/cars/mercedes_sls/scene.gltf',
                position: [-6, 2, -70],
                scale: [8, 8, 8],
                rotation: [0, Math.PI / 2, 0]
            },
        ...
        let car, policeCar, character, bike, americanMuscleCarCar, bmwE30Car, camper1Car, camper2Car, chevroletCruzeCar,
            chevroletImpalaCar, ferrari458Car, fiat500Car, fordCar, deliveryVanCar, gmcSierraCar, hyundaiBusCar, lotusCar, mercedesCar,
            militaryTruckCar, militaryTruck2Car, nissanGTCar, nissanDatsunCar, rangeRoverCar, truckCar, zis101Car, lowpolyBmwCar, 
            lowpolyCarCar, lowpolyCarsCar, lowpolySmallCarCar, lowpolyTruckCar, lowpolyVanHippieCar, lowpolyFordAngilaCar, lowpolyRafTaxiVanCar,
            lowpolyTaxiOldStyleCar, lowpolyLimousineCar, lowpolyE7CivilianCar, lowpolyPoliceCarCar, lowpolyPoliceVanCar, lowpolySheriffCar;
            ...
            for (const model of Object.values(dynamicModels)) {
                ...
                switch (model) {
                    ...
                    case dynamicModels.lowpolySmallCar:
                        ...
                        addCarModel(model, ["FR_Wheel", "RR_Wheel", "FL_Wheel", "RL_Wheel"], carInfo);
                        break;

                    case dynamicModels.lowpolyVanHippie:
                        // Specs for low poly Van Hippie 
                        carInfo = {
                            mass: 1800,    // Kg
                            maxSpeed: 90, // Km/h
                            boxSizeXFactor: 0.5,
                        ...
                        addCarModel(model, ["Wheel", "Wheel_1", "Wheel_2", "Wheel_3"], carInfo);
                        break;


                    case dynamicModels.lowpolyTaxiOldStyle:
                        // Specs for low poly car yellow
                        carInfo = {
                            mass: 1000,    // Kg
                            maxSpeed: 100, // Km/h
                            boxSizeXFactor: 0.5,
                        ...
                        addCarModel(model, ["wheel_1", "wheel_2", "wheel_3", "wheel_4"], carInfo);
                        break;
                    ...
                    case dynamicModels.lowpolyCar:
                        ...
                        addCarModel(model, ["FRWheel", "RRWheel", "FLWheel", "RLWheel"], carInfo);
                        break;

                    case dynamicModels.lowpolyTruck:
                        // Specs for low poly truck
                        carInfo = {
                            mass: 500,    // Kg
                            maxSpeed: 100, // Km/h
                            boxSizeXFactor: 0.5,
                        ...
                        addCarModel(model, ["mesh_0", "mesh_1", "mesh_2", "mesh_3"], carInfo);
                        break;
                    ...
                    case dynamicModels.lowpolyRafTaxiVan:
                        // Specs for low poly car yellow
                        carInfo = {
                            mass: 1000,    // Kg
                            maxSpeed: 100, // Km/h
                        ...
                        addCarModel(model, ["pCylinder7_rubber_0", "pCylinder9_rubber_0", "pCylinder2_rubber_0", "pCylinder5_rubber_0"], carInfo);
                        break;
                    ...
                    case dynamicModels.lowpolyPoliceVan:
                        // Specs for low poly car yellow
                        carInfo = {
                            mass: 1000,    // Kg
                            maxSpeed: 100, // Km/h
                        ...
                        addCarModel(model, ["Empty_1", "Empty001_3", "Empty002_5", "Empty003_7"], carInfo);
                        break;




                    case dynamicModels.lowpolySheriff:
                        // Specs for low poly car yellow
                        carInfo = {
                            mass: 1000,    // Kg
                            maxSpeed: 100, // Km/h
                        ...
                        addCarModel(model, ["YukonWheelFtL", "YukonWheelFtR", "YukonWheelBkL", "YukonWheelBkR"], carInfo);
                        break;
        ...
        if (environment == environments.CITY) {
            ...
            //Utils.makeXYZGUI(gui, sunlight.position, 'Sun positionn');
        ...
        //MIO CODICE  (ho corretto environment con environments)
        ...
        { // Lateral limits
            ...
            if (environment == environments.COUNTRY) leftLimit.position.x = 15;
        ...
        /*
        var myGeometry = new THREE.CubeGeometry(2000, 2000, 2000);
        var cubeMaterials = [
        ...
        */
        ...
        function animate(time) {
            ...
            console.log(player.getModel());
            if (car) {
                translateModels();
                moveCars();

                if (player.getPosition().z < cube.position.z) {
                    cube.position.set(0, 0, cube.position.z - 400);
            ...
            function translateModels() {
                for (const model of Object.values(staticModels)) {
                    var buildingPosition = model.gltf.scene.position;
                    if (player.getPosition().z < buildingPosition.z - 80) {
                    ...
                    if (player.getPosition().z - buildingPosition.z < 400) {
            ...
            function moveCars() {
                ...
                for (const model of Object.values(dynamicModels)) {
                    var carPosition = model.gltf.scene.position;
                    if (model != dynamicModels.lamborghini) {
                        ...
                        switch (model) {
                            ...
                            case dynamicModels.americanMuscleCar:
                                currentCar = americanMuscleCarCar;
                                break;
                            case dynamicModels.bmwE30:
                                currentCar = bmwE30Car;
                                break;
                            case dynamicModels.camper1:
                                currentCar = camper1Car;
                                break;
                            case dynamicModels.camper2:
                                currentCar = camper2Car;
                                break;
                            case dynamicModels.chevroletCruze:
                                currentCar = chevroletCruzeCar;
                                break;
                            case dynamicModels.chevroletImpala:
                                currentCar = chevroletImpalaCar
                                break;
                            case dynamicModels.ferrari458:
                                currentCar = ferrari458Car;
                                break;
                            case dynamicModels.fiat500:
                                currentCar = fiat500Car;
                                break;
                            case dynamicModels.ford:
                                currentCar = fordCar;
                                break;
                            case dynamicModels.deliveryVan:
                                currentCar = deliveryVanCar;
                                break;
                            case dynamicModels.gmcSierra:
                                currentCar = gmcSierraCar;
                                break;
                            case dynamicModels.hyundaiBus:
                                currentCar = hyundaiBusCar;
                                break;
                            case dynamicModels.lotus:
                                currentCar = lotusCar;
                                break;
                            case dynamicModels.mercedes:
                                currentCar = mercedesCar;
                                break;
                            case dynamicModels.militaryTruck:
                                currentCar = militaryTruckCar;
                                break;
                            case dynamicModels.militaryTruck2:
                                currentCar = militaryTruck2Car;
                                break;
                            case dynamicModels.nissanGT:
                                currentCar = nissanGTCar;
                                break;
                            case dynamicModels.nissanDatsun:
                                currentCar = nissanDatsunCar;
                                break;
                            case dynamicModels.rangeRover:
                                currentCar = rangeRoverCar;
                                break;
                            case dynamicModels.truck:
                                currentCar = truckCar;
                                break;
                            case dynamicModels.zis101:
                                currentCar = zis101Car;
                                break;
                            case dynamicModels.lowpolyBmw:
                                currentCar = lowpolyBmwCar;
                                break;
                            case dynamicModels.lowpolyCar:
                                currentCar = lowpolyCarCar;
                                break;
                            case dynamicModels.lowpolyCars:
                                currentCar = lowpolyCarsCar;
                                break;
                            case dynamicModels.lowpolySmallCar:
                                currentCar = lowpolySmallCarCar;
                                break;
                            case dynamicModels.lowpolyTruck:
                                currentCar = lowpolyTruckCar;
                                break;
                            case dynamicModels.lowpolyVanHippie:
                                currentCar = lowpolyVanHippieCar;
                                break;
                            case dynamicModels.lowpolyFordAngila:
                                currentCar = lowpolyFordAngilaCar;
                                break;
                            case dynamicModels.lowpolyRafTaxiVan:
                                currentCar = lowpolyRafTaxiVanCar;
                                break;
                            case dynamicModels.lowpolyTaxiOldStyle:
                                currentCar = lowpolyTaxiOldStyleCar;
                                break;
                            case dynamicModels.lowpolyLimousine:
                                currentCar = lowpolyLimousineCar;
                                break;
                            case dynamicModels.lowpolyE7Civilian:
                                currentCar = lowpolyE7CivilianCar;
                                break;
                            case dynamicModels.lowpolyPoliceVan:
                                currentCar = lowpolyPoliceVanCar;
                                break;
                            case dynamicModels.lowpolySheriff:
                                currentCar = lowpolySheriffCar;
                                break;
                        ...
                        */
                        ...
                        if (currentCar)
                        {
                            if (Math.abs(player.getPosition().z > carPosition.z - 200) || model.gltf.scene.visible == false)
                            {
                                model.gltf.scene.visible = true;
                                currentCar.move(2, 2, -0.2, 0.1);
                            ...
                            else
                            {
                                ...
                                if(ms)
                                {
                                    ...
                                    transform.setOrigin(new Ammo.btVector3(
                                        ...
                                        carPosition.y,
                                        carPosition.z - 500));
                                    const model3D = currentCar.get3DModel();
                                    transform.setRotation(new Ammo.btQuaternion(
                                        model3D.quaternion.x,
                                        model3D.quaternion.y,
                                        model3D.quaternion.z,
                                        model3D.quaternion.w));
        ...
        function addCarModel(model, wheelsNames, carInfo) {
            ...
            //new Car(modelScene, carInfo, game, carInfo.carName, components);  COMMENTATO IO
            ...
            switch (model) {
                // Cars
                case dynamicModels.americanMuscleCar:
                    americanMuscleCarCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.bmwE30:
                    bmwE30Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.camper1:
                    camper1Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.camper2:
                    camper2Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.chevroletCruze:
                    chevroletCruzeCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.chevroletImpala:
                    chevroletImpalaCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.ferrari458:
                    ferrari458Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.fiat500:
                    fiat500Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.ford:
                    fordCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.deliveryVan:
                    deliveryVanCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.gmcSierra:
                    gmcSierraCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.hyundaiBus:
                    hyundaiBusCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lotus:
                    lotusCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.mercedes:
                    mercedesCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.militaryTruck:
                    militaryTruckCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.militaryTruck2:
                    militaryTruck2Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.nissanGT:
                    nissanGTCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.nissanDatsun:
                    nissanDatsunCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.rangeRover:
                    rangeRoverCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.truck:
                    truckCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.zis101:
                    zis101Car = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyBmw:
                    lowpolyBmwCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyCar:
                    lowpolyCarCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyCars:
                    lowpolyCarsCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolySmallCar:
                    lowpolySmallCarCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyTruck:
                    lowpolyTruckCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyVanHippie:
                    lowpolyVanHippieCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyFordAngila:
                    lowpolyFordAngilaCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyRafTaxiVan:
                    lowpolyRafTaxiVanCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyTaxiOldStyle:
                    lowpolyTaxiOldStyleCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyLimousine:
                    lowpolyLimousineCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolyE7Civilian:
                    lowpolyE7CivilianCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                    
                case dynamicModels.lowpolyPoliceVan:
                    lowpolyPoliceVanCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
                case dynamicModels.lowpolySheriff:
                    lowpolySheriffCar = new Car(modelScene, carInfo, game, carInfo.carName, components);
                    break;
            }
