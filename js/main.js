    ...
    function setupGraphics() {
        ...
        function translateStaticModels(zPosPlayer) {
            ...
            for (const model of Object.values(staticModels)) {
                ...
                if (model != staticModels.jerseyGroup && model != staticModels.jerseyGroup2 && model != staticModels.sidewalks1 && model != staticModels.sidewalks2 && model != staticModels.highwayFenceSx && model != staticModels.highwayFenceSx2 && model != staticModels.highwayFenceDx && model != staticModels.highwayFenceDx2) {
                    ...
                    else if (model == staticModels.highwayFenceSx || model == staticModels.highwayFenceDx || model == staticModels.highwayFenceSx2 || model == staticModels.highwayFenceDx2) {
                        surpassDistance = 100;
                        respawnDistance = 500;
                    }
                ...
                if (model != playerModel && model != policeSelModel) {
                    ...
                    if (currentCar) {
                        ...
                        if (Math.abs(zPosPlayer > carPosition.z - 200) || model.gltf.scene.visible == false) {
                            model.gltf.scene.visible = true;
                            // TODO choose between the two: -1 move forward, 1 backward
                            // To be fixed, temp
        ...
        function addCarModel(model) {
            ...
            console.log(environment, "ECCCOLOOOOOOOOOOOO");
            console.log(lanexUp, "CI SIAMOOO");
            ...
            if (model == dynamicModels.audiR8 || model == dynamicModels.bmwE30 || model == dynamicModels.fordFoxSedan)
                ...
                var random = lanexDown[Math.floor(Math.random() * lanexUp.length)];


            if (model != dynamicModels.lamborghini) {
                modelScene.position.set(...model.position);
                modelScene.position.set(random, modelScene.position.y, modelScene.position.z);
